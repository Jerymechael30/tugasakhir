    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">Informasi Data Gangguan</h2>
                <div class="card-tools">
                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#tambahPenyakit" id="btnTambahPenyakit">Tambah Gangguan</button>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= site_url('penyakit/delete/'.$item['id']) ?>" 
                                            ...
                                            data-message="Yakin ingin menghapus gangguan ini?">
                                            Delete
                                        </a>
                                    </td>
                                </tr>
...
<script>
    $(document).ready(function () {
        $('#btnTambahPenyakit').on('click', function () {
            ...
            $('#modalTambahLabel').text('Tambah Gangguan');
        ...
        $('.btnEditPenyakit').on('click', function () {
            setTimeout(() => {
                $('#modalTambahLabel').text('Edit Gangguan');
                $('#formPenyakit').attr('action', '<?= site_url('penyakit/store') ?>');
                $('#mode').val('edit');
                $('#id').val($(this).data('id'));
