    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">Informasi Data User</h2>
                <div class="card-tools">
                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#tambahPengguna" id="btnTambahPengguna">Tambah User</button>
                </div>
            </div>
            <div class="card-body">
...
<?php $this->load->view('modal/modal_user'); ?>
